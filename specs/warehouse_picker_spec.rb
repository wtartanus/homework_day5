...
def test_bays_items_distance_calculate
  ...
  assert_equal("nail filer, tooth paste, cookie jar, they're 5 bays apart", item_first)
  assert_equal("blouse, paint brush, shoe lace, picture frame, they're 15 bays apart", item_second)
end
...
def test_items_find_bays_and_order_from_entrance
  ...
  assert_equal("c1, c9, c10", item_first)
  assert_equal("a10, a4, c8, b9",item_second)
end
